                    ...
                    <?php foreach ($data['farhan'] as $frhn) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="http://localhost/PHP-MVC/public/farhan/getIdPenghuni/<?php echo $frhn['id_Penghuni']; ?>" class="btn btn-success">Edit</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="http://localhost/PHP-MVC/public/farhan/addFarhan" method="post" enctype="multipart/form-data">
