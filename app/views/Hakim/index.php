    ...
    <div class="row">
        <div class="col-6">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php foreach ($data['Hakim'] as $hkm) : ?>
                        <tr>
                            <td><?php echo $hkm['nama_penghuni']; ?></td>
                            <td><?php echo $hkm['alamat']; ?></td>
                            <td><?php echo $hkm['jenis_kelamin']; ?></td>
                            <td><?php echo $hkm['agama']; ?></td>
                            <td><img src="http://localhost/phpmvc/public/public/image/<?php echo $hkm['foto']; ?>" alt="Foto Penghuni"></td>
                            <td>
                                <form method="POST" action="http://localhost/phpmvc/public/penghuni/deletePenghuni/<?php echo $hkm['id_Penghuni']; ?>">
                                    <button type="submit" onclick="return confirm('apakah ingin dihapus')" class="btn btn-danger">Hapus</button>
                                </form>
                                <a href="http://localhost/phpmvc/public/penghuni/editPenghuni/<?php echo $hkm['id_Penghuni']; ?>" class="btn btn-success">Edit</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="http://localhost/PHP-MVC/public/Hakim/addHakim" method="post" enctype="multipart/form-data">
