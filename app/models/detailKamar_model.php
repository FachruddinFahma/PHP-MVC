<?php
    class detailKamar_model
    {
        ...
        {
            $this->db->query("SELECT tb_kost.alamat, tb_kost.id_user, tb_kamar.fasilitas, tb_kamar.ukuran, tb_kost.fasilitas_kost, tb_kost.peraturan_kost, tb_kamar.harga_harian, tb_kamar.harga_bulanan, 
